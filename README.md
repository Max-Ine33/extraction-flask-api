...
| POST        | /articles                       | Upload a new article to the database              | N/A                                                                   | JSON                                            |                                            |
...
| GET         | /articles/{article_id}          | Describe the requested article, all metadata      | `article_id` (path parameter)                                       | JSON                                            | If article not in the database, fetch from arXiv API. |
