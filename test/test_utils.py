...
class UtilsTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with app.app_context():
            ...
            test_article_1 = Article(id="test_article_1", title="Test Article 1", summary="Summary 1", published_date="2024-01-27")
            test_article_2 = Article(id="test_article_2", title="Test Article 2", summary="Summary 2", published_date="2024-01-28")
    ...
    def test_get_arxiv_articles(self, mock_requests_get):
        ...
        file_path = (Path(__file__).parent / 'test_data' / '2401.13999-arxiv.xml').resolve()
        ...
        expected_output_path = (Path(__file__).parent / 'test_data' / '2401.13999-function.json').resolve()
        ...
        self.assertEqual(json.dumps(result[0], sort_keys=True),
